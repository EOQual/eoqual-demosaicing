...
_DISPATCH = {
    ...
    "bilinear": ("eoqual.demosaicing.backends.bilinear.channelwise", "bilinear_demosaic", {}),
    "green_edge_based": ("eoqual.demosaicing.backends.green_edge_based.directional", "green_edge_based_demosaic", {}),
    "malvar": ("eoqual.demosaicing.backends.malvar.he_cutler", "malvar_demosaic", {}),
    "malvar_bilateral": ("eoqual.demosaicing.backends.malvar_bilateral.bilateral", "malvar_bilateral_demosaic", {}),
    ...
    "ahd": ("eoqual.demosaicing.backends.ahd.homogeneity", "ahd_demosaic", {}),
    "mrf": ("eoqual.demosaicing.backends.mrf.diffusion", "mrf_demosaic", {}),
